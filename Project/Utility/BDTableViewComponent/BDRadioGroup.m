...
@interface BDRadioGroup()

@property (nonatomic, readonly, BD_WEAK) UIViewController* controller;
@property (nonatomic, readonly, BD_STRONG) NSMutableDictionary* objectMap;
@property (nonatomic, readonly, BD_STRONG) NSMutableSet* objectSet;
@property (nonatomic, readonly, BD_STRONG) NSMutableArray* objectOrder;
@property (nonatomic, assign) BOOL hasSelection;
@property (nonatomic, readonly, BD_STRONG) NSMutableSet* forwardDelegates;
...
#pragma mark - BDCellObject



- (Class)cellClass {
    return [BDRadioGroupCell class];
}
...
- (id)mapObject:(id)object toIdentifier:(NSInteger)identifier {
    ...
    NSParameterAssert(identifier != kInvalidSelection);
    NSParameterAssert(![self isObjectInRadioGroup:object]);
    if (nil == object) {
        return nil;
    }
...
- (void)setSelectedIdentifier:(NSInteger)selectedIdentifier {
    ...
    NSParameterAssert(nil != [self.objectMap objectForKey:key]);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([tableView.dataSource isKindOfClass:[BDTableViewModel class]]) {
        ...
        if (object == self) {
            ...
            NSParameterAssert(nil != self.controller);
            
            BDRadioGroupController* controller = [[BDRadioGroupController alloc] initWithRadioGroup:self tappedCell:(id<BDCellProtocol>)[tableView cellForRowAtIndexPath:indexPath]];
...
@implementation BDRadioGroupCell
